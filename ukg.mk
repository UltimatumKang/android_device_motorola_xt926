...
# device
$(call inherit-product-if-exists, device/motorola/xt926/full_xt926.mk)
...
PRODUCT_NAME := ukg_xt926
PRODUCT_MODEL := Droid Razr HD
PRODUCT_MANUFACTURER := Motorola
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.xt926.$(shell date +%m%d%y).$(shell date +%H%M%S)
